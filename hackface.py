...
def baliho():
	try:
		...
		print ' ' + W
		print ('HACKFACE').center(44)
		print (W + '     [' + G +'información de código abierto facebook'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     GILILLO GONZALEZ
    Name       hackface 'información de código abierto facebook'
    CodeName   seguir
    version    full version
    Date       16/05/2018 09:35:12
    Team       Blackhole Security
    Email      gilillogonzalez@gmail.com
    Telegram   @gilillo

* Si encuentra algún error o problema, póngase en contacto con el
  author
'''%(G,W)
def info_ga():
  ...
  -------------       -------------------------------------
   ...
   get_data           buscando todos los datos de amigos.

   get_info            muestra información sobre tu amigo.

   dump_id            obteniendo todos los identificadores de la lista de amigos.

   dump_phone         obteniendo todos los números de teléfono de la lista de amigos.

   dump_mail          recuperando todos los correos electrónicos de la lista de amigos.

   dump_<id>_id       obteniendo toda la identificación de tu amigo.
 <spesific>
		      ex: dump_username_id

   token              Generar token de acceso
   cat_token          muestra tu token de acceso
   rm_token           quitar token de acceso
...
def get(data):
	...
	try:
		...
		b.close()
		print '[*] generar correctamente el token de acceso'
		print '[*] Su token de acceso se almacena en cookie / token.log'
		exit()
	except KeyError:
		...
		print '[!] Error al generar el token de acceso'
		print '[!] Connection error !!!'
		os.remove('cookie/token.log')
		main()
def id():
	print '[*] ingresa a tu cuenta de facebook         ';id = raw_input('[?] Username : ');pwd = getpass.getpass('[?] Password : ');API_SECRET = '62f8ce9f74b12f84c123cc23437a4a32';data = {"api_key":"882a8490361da98702bf97a021ddc14d","credentials_type":"password","email":id,"format":"JSON", "generate_machine_id":"1","generate_session_cookies":"1","locale":"en_US","method":"auth.login","password":pwd,"return_ssl_resources":"0","v":"1.0"};sig = 'api_key=882a8490361da98702bf97a021ddc14dcredentials_type=passwordemail='+id+'format=JSONgenerate_machine_id=1generate_session_cookies=1locale=en_USmethod=auth.loginpassword='+pwd+'return_ssl_resources=0v=1.0'+API_SECRET
	x = hashlib.new('md5')
        x.update(sig)
...
def post():
	...
	try:
	  if WT == 'wallpost':
		print '[*] buscando todos los mensajes'
		...
		print '[*] buscando todas las solicitudes de amigos'
		...
		print '[*] buscando a todos los amigos'
		...
		print '[*] buscando todos los álbumes id'
		...
		print '[!] no se pudo recuperar todas las ID de publicación'
		print '[!] Stopped'
		bot()
	except requests.exceptions.ConnectionError:
		print '[!] Connection Error'
...
def like(posts , amount):
	...
	print '\r[*] Todos los mensajes id exitosamente recuperados            '
	print '[*] Start'
...
def confirm(posts):
	...
	print '\r[*] Todas las solicitudes de amistad recuperadas exitosamente        '
	print '[*] Start'
